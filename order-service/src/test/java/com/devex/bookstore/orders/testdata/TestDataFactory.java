package com.devex.bookstore.orders.testdata;

import static org.instancio.Select.field;

import com.devex.bookstore.orders.domain.models.Address;
import com.devex.bookstore.orders.domain.models.CreateOrderRequest;
import com.devex.bookstore.orders.domain.models.Customer;
import com.devex.bookstore.orders.domain.models.OrderItem;
...
public class TestDataFactory {
    static final List<String> VALID_COUNTIES = List.of("Tunisia", "Germany");
